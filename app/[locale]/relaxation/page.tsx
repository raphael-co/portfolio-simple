            ...
            <div className="flex items-start justify-between gap-4">
                <div className="space-y-2 md:space-y-3">
                    ...
                    <p className="max-w-3xl text-pretty text-sm opacity-80 sm:text-base">
                        {locale === "fr"
                            ? "Un mini-jeu simple, relaxant et compétitif : 5 réactions chronométrées chaque jour, basées sur la date du jour. Défie ton meilleur score."
                            : "A simple, calming, competitive mini-game: 5 timed reactions each day, based on the date. Beat your best score."}
